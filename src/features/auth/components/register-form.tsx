                ...
                <form className="space-y-5">
                    <div className="space-y-4">
                        ...
                        <Input
                            ...
                            placeholder="••••••••"
                            description="Must be at least 8 characters and include an uppercase letter, a number, and a special character."
                        />
                    ...
                    <div className="relative py-3">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-neutral-50 px-3 text-[10px] font-semibold tracking-widest text-muted-foreground uppercase">
                                Or continue with
                            </span>
                        </div>
                    </div>
