            ...
            <div className="w-full max-w-md mx-auto">
                ...
                <header className="mb-10 space-y-3 text-center lg:text-left">
                    ...
                    <p className="mt-4 text-muted-foreground text-sm leading-relaxed">
                        Access your private collection, saved pieces, and member-exclusive releases.
                    </p>
                </header>
                ...
                <form className="space-y-5">
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center">
                                <span
                                    className="bg-card px-4 text-xs font-medium tracking-wider text-muted-foreground uppercase">
                                    Or continue with
                                </span>
                        </div>
                    </div>
