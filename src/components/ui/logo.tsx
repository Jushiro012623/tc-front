...
export const BrandLogo = ({iconOnly = true}: { iconOnly?: boolean }) => {
    ...
    return (
        <div className="flex items-center gap-3">
            <div
                className="size-12 text-white rounded-xl overflow-hidden p-1.5 bg-accent backdrop-blur flex items-center justify-center font-semibold">
